...
var BasicPubSubClient = /** @class */ (function (_super) {
     ...
     * @expandParams
     */
    function BasicPubSubClient(options) {
        var _a;
        var _this = _super.call(this) || this;
        // topic => token
        _this._topics = new Map();
        _this._pingOnInactivity = 60;
        _this._pingTimeout = 10;
        _this._onPong = _this.registerInternalEvent();
        _this._onResponse = _this.registerInternalEvent();
        /**
        ...
        _this._logger = new logger_1.Logger(tslib_1.__assign({ name: 'twitch-pubsub-client', emoji: true }, ((_a = options.logger) !== null && _a !== void 0 ? _a : {})));
        _this._connection = new connection_1.PersistentConnection(connection_1.WebSocketConnection, { hostName: 'pubsub-edge.twitch.tv', port: 443, secure: true }, { logger: _this._logger }, { wsOptions: options.wsOptions });
        _this._connection.onConnect(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    BasicPubSubClient_1 = BasicPubSubClient;
    /**
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        wrapped = BasicPubSubClient_1._wrapResolvable(tokenResolvable, scope);
                        try {
    ...
    BasicPubSubClient._wrapResolvable = function (resolvable, scope) {
        switch (typeof resolvable) {
            ...
            default: {
                throw new twitch_common_1.HellFreezesOverError("Passed unknown type to wrapResolvable: " + typeof resolvable);
            }
        }
    };
    BasicPubSubClient.prototype._resolveToken = function (resolvable) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, provider, scopes, accessToken;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = resolvable.type;
                        switch (_a) {
                            ...
                            case 'function': return [3 /*break*/, 3];
                            case 'static': return [3 /*break*/, 4];
                            case 'null': return [3 /*break*/, 5];
                        }
                        return [3 /*break*/, 6];
                    case 1:
                        provider = resolvable.provider, scopes = resolvable.scopes;
                        return [4 /*yield*/, twitch_auth_1.getValidTokenFromProvider(provider, scopes, this._logger)];
                    case 2:
                    ...
                    case 6:
                        {
                            throw new twitch_common_1.HellFreezesOverError("Passed unknown type to resolveToken: " + resolvable.type);
                        }
                        _b.label = 7;
    ...
    BasicPubSubClient.prototype._resendListens = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var topicsByTokenResolvable, _a, _b, _c, topic, tokenResolvable, topicsByToken, topicsByTokenResolvable_1, topicsByTokenResolvable_1_1, _d, tokenResolvable, topics, token, e_3_1;
            ...
            return tslib_1.__generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        ...
                        try {
                            for (_a = tslib_1.__values(this._topics), _b = _a.next(); !_b.done; _b = _a.next()) {
                                _c = tslib_1.__read(_b.value, 2), topic = _c[0], tokenResolvable = _c[1];
                    ...
                    case 1:
                        ...
                        topicsByTokenResolvable_1 = tslib_1.__values(topicsByTokenResolvable), topicsByTokenResolvable_1_1 = topicsByTokenResolvable_1.next();
                        _h.label = 2;
                    case 2:
                        if (!!topicsByTokenResolvable_1_1.done) return [3 /*break*/, 5];
                        _d = tslib_1.__read(topicsByTokenResolvable_1_1.value, 2), tokenResolvable = _d[0], topics = _d[1];
                        return [4 /*yield*/, this._resolveToken(tokenResolvable)];
                    case 3:
                        token = _h.sent();
                        if (topicsByToken.has(token)) {
                            (_g = topicsByToken.get(token)).push.apply(_g, tslib_1.__spread(topics));
                        }
                        else {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        var responseListener = _this._onResponse(function (recvNonce, error) {
                            if (recvNonce === nonce) {
                                if (error) {
    ...
    BasicPubSubClient.prototype._pingCheck = function () {
        ...
        this._onPong(function () {
            ...
            _this.removeInternalListener(_this._onPong);
        });
    ...
    BasicPubSubClient = BasicPubSubClient_1 = tslib_1.__decorate([
        twitch_common_1.rtfm('twitch-pubsub-client', 'BasicPubSubClient')
    ], BasicPubSubClient);
