...
var PubSubRedemptionMessage = /** @class */ (function () {
    /** @private */
    function PubSubRedemptionMessage(data, apiClient) {
        this._data = data;
    ...
    Object.defineProperty(PubSubRedemptionMessage.prototype, "defaultImage", {
        /**
    ...
    __decorate([
        Enumerable(false)
    ], PubSubRedemptionMessage.prototype, "_data", void 0);
    PubSubRedemptionMessage = __decorate([
        rtfm('twitch-pubsub-client', 'PubSubRedemptionMessage', 'id')
