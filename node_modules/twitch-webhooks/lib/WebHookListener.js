...
var HypeTrainEventSubscription_1 = require("./Subscriptions/HypeTrainEventSubscription");
...
var WebHookListener = /** @class */ (function () {
    ...
    function WebHookListener(apiClient, adapter, config) {
        ...
        this._defaultHookValidity = (_a = config.hookValidity) !== null && _a !== void 0 ? _a : adapter.overrideOptions.defaultHookValidity;
        this._logger = new logger_1.Logger(tslib_1.__assign({ name: 'twitch-webhooks', emoji: true }, ((_b = config.logger) !== null && _b !== void 0 ? _b : {})));
    }
    WebHookListener_1 = WebHookListener;
    /**
     * Creates a new WebHook listener.
     *
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        adapter = _a.sent();
                        return [2 /*return*/, new WebHookListener_1(apiClient, adapter, config)];
                }
            });
        });
    };
    ...
    WebHookListener.prototype.subscribeToUserChanges = function (user, handler, withEmail, validityInSeconds) {
        ...
        if (validityInSeconds === void 0) { validityInSeconds = this._defaultHookValidity; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var userId;
            return tslib_1.__generator(this, function (_a) {
                userId = twitch_common_1.extractUserId(user);
                if (!numberRegex.test(userId)) {
                    this._logger.warn('WebHookListener#subscribeToUserChanges: The given user is a non-numeric string. You might be sending a user name instead of a user ID.');
                }
                return [2 /*return*/, this._genericSubscribe(UserChangeSubscription_1.UserChangeSubscription, handler, this, validityInSeconds, userId, withEmail)];
            });
        });
    };
    /**
    ...
    WebHookListener.prototype.subscribeToFollowsToUser = function (user, handler, validityInSeconds) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                userId = twitch_common_1.extractUserId(user);
                if (!numberRegex.test(userId)) {
                    this._logger.warn('WebHookListener#subscribeToFollowsToUser: The given user is a non-numeric string. You might be sending a user name instead of a user ID.');
                }
                return [2 /*return*/, this._genericSubscribe(FollowsToUserSubscription_1.FollowsToUserSubscription, handler, this, validityInSeconds, userId)];
            });
        });
    };
    /**
    ...
    WebHookListener.prototype.subscribeToFollowsFromUser = function (user, handler, validityInSeconds) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                userId = twitch_common_1.extractUserId(user);
                if (!numberRegex.test(userId)) {
                    this._logger.warn('WebHookListener#subscribeToFollowsFromUser: The given user is a non-numeric string. You might be sending a user name instead of a user ID.');
                }
                return [2 /*return*/, this._genericSubscribe(FollowsFromUserSubscription_1.FollowsFromUserSubscription, handler, this, validityInSeconds, userId)];
            });
        });
    };
    /**
     ...
     * This is meant for debugging issues. Please don't set it unless you know what you're doing.
     */
    WebHookListener.prototype.subscribeToHypeTrainEvents = function (broadcaster, handler, validityInSeconds) {
        if (validityInSeconds === void 0) { validityInSeconds = this._defaultHookValidity; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var broadcasterId;
            return tslib_1.__generator(this, function (_a) {
                ...
                if (!numberRegex.test(broadcasterId)) {
                    this._logger.warn('WebHookListener#subscribeToHypeTrainEvents: The given broadcaster is a non-numeric string. You might be sending a user name instead of a user ID.');
                }
                return [2 /*return*/, this._genericSubscribe(HypeTrainEventSubscription_1.HypeTrainEventSubscription, handler, this, validityInSeconds, broadcasterId)];
            });
        });
    };
    /**
    ...
    WebHookListener.prototype.subscribeToStreamChanges = function (user, handler, validityInSeconds) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                userId = twitch_common_1.extractUserId(user);
                if (!numberRegex.test(userId)) {
                    this._logger.warn('WebHookListener#subscribeToStreamChanges: The given user is a non-numeric string. You might be sending a user name instead of a user ID.');
                }
                return [2 /*return*/, this._genericSubscribe(StreamChangeSubscription_1.StreamChangeSubscription, handler, this, validityInSeconds, userId)];
            });
        });
    };
    /**
     ...
     * This is meant for debugging issues. Please don't set it unless you know what you're doing.
     */
    WebHookListener.prototype.subscribeToSubscriptionEvents = function (broadcaster, handler, validityInSeconds) {
        if (validityInSeconds === void 0) { validityInSeconds = this._defaultHookValidity; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var broadcasterId;
            return tslib_1.__generator(this, function (_a) {
                broadcasterId = twitch_common_1.extractUserId(broadcaster);
                if (!numberRegex.test(broadcasterId)) {
                    this._logger.warn('WebHookListener#subscribeToSubscriptionEvents: The given broadcaster is a non-numeric string. You might be sending a user name instead of a user ID.');
                }
                return [2 /*return*/, this._genericSubscribe(SubscriptionEventSubscription_1.SubscriptionEventSubscription, handler, this, validityInSeconds, broadcasterId)];
            });
        });
    };
    /**
    ...
    WebHookListener.prototype.subscribeToBanEvents = function (broadcaster, handler, user, validityInSeconds) {
        if (validityInSeconds === void 0) { validityInSeconds = this._defaultHookValidity; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var broadcasterId, userId;
            return tslib_1.__generator(this, function (_a) {
                broadcasterId = twitch_common_1.extractUserId(broadcaster);
                userId = user ? twitch_common_1.extractUserId(user) : undefined;
                if (!numberRegex.test(broadcasterId)) {
                    this._logger.warn('WebHookListener#subscribeToBanEvents: The given broadcaster is a non-numeric string. You might be sending a user name instead of a user ID.');
                }
                if (userId !== undefined && !numberRegex.test(userId)) {
                    this._logger.warn('WebHookListener#subscribeToBanEvents: The given user is a non-numeric string. You might be sending a user name instead of a user ID.');
                }
                return [2 /*return*/, this._genericSubscribe(BanEventSubscription_1.BanEventSubscription, handler, this, validityInSeconds, broadcasterId, userId)];
            });
        });
    };
    /**
    ...
    WebHookListener.prototype.subscribeToModeratorEvents = function (broadcaster, handler, user, validityInSeconds) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                userId = user ? twitch_common_1.extractUserId(user) : undefined;
                if (!numberRegex.test(broadcasterId)) {
                    this._logger.warn('WebHookListener#subscribeToModeratorEvents: The given broadcaster is a non-numeric string. You might be sending a user name instead of a user ID.');
                }
                if (userId !== undefined && !numberRegex.test(userId)) {
                    this._logger.warn('WebHookListener#subscribeToModeratorEvents: The given user is a non-numeric string. You might be sending a user name instead of a user ID.');
                }
                return [2 /*return*/, this._genericSubscribe(ModeratorEventSubscription_1.ModeratorEventSubscription, handler, this, validityInSeconds, broadcasterId, userId)];
            });
        });
    };
    /**
    ...
    WebHookListener.prototype.subscribeToExtensionTransactions = function (extensionId, handler, validityInSeconds) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, this._genericSubscribe(ExtensionTransactionSubscription_1.ExtensionTransactionSubscription, handler, this, validityInSeconds, extensionId)];
            });
        });
    };
    /** @private */
    ...
    WebHookListener.prototype._genericSubscribe = function (clazz, handler, client, validityInSeconds) {
        var params = [];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        subscription = new (clazz.bind.apply(clazz, tslib_1.__spread([void 0, handler, client, validityInSeconds], params)))();
    ...
    var WebHookListener_1;
    WebHookListener = WebHookListener_1 = tslib_1.__decorate([
        twitch_common_1.rtfm('twitch-webhooks', 'WebHookListener')
    ], WebHookListener);
